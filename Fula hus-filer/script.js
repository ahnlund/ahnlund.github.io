...
var ENDSHOW_MESG="Bildspelet är slut, klicka för att avsluta.", SCREEN_MODE="Frames", gIsEndShow=0, NUM_VIS_SLDS=8, SCRIPT_HREF="script.js", FULLSCR_HREF="fullscreen.htm";
...
var gMainDoc=new Array(new hrefList("slide0004.htm",1,7943,1),new hrefList("slide0008.htm",1,6500,1),new hrefList("slide0001.htm",1,7472,1),new hrefList("slide0002.htm",1,6901,1),new hrefList("slide0003.htm",1,9835,1),new hrefList("slide0011.htm",1,-1,1),new hrefList("slide0013.htm",1,-1,1),new hrefList("slide0012.htm",1,-1,1));
